...
def init():
    f = open(SettingsLogging.roll,'w') #opens a file (first variable) in write mode (w) and stores in f
...
def run():
    ...
    with open(SettingsLogging.roll,'a') as g: #opens the same file as before but now in append mode (a)
