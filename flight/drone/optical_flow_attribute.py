...
class OpticalFlow(object):
    ...
    def __str__(self):
        ...
        """
        return "OPTICAL_FLOW: time_usec={},sensor_id={},flow_x={},flow_y={}, \
            flow_comp_m_x={},flow_comp_m_y={},quality={}, \
                ground_distance={}".format(
                    self.time_usec, self.sensor_id, self.flow_x,
                    self.flow_y,self.flow_comp_m_x,self.flow_comp_m_y,
                    self.quality,self.ground_distance)
